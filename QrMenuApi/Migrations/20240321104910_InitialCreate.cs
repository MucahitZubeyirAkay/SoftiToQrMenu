        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterDate = table.Column<DateTime>(type: "smalldatetime", nullable: false),
                    StateId = table.Column<byte>(type: "tinyint", nullable: false),
                    RestraurantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Categories_Restaurants_RestraurantId",
                        column: x => x.RestraurantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_RestraurantId",
                table: "Categories",
                column: "RestraurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantUser_ApplicationUserId",
